...
const PALETTES = [
  ["#c2502a", "#1a1815", "#ebe7df"],   // terracotta
  ...
  return (
    <>
      ...
      <main>
        ...
        {route.name === "writing" && <WritingPage setRoute={setRoute} ownerMode={!!t.ownerMode} />}
        {route.name === "contact" && <ContactPage setRoute={setRoute} />}
      </main>
      <Footer setRoute={setRoute} />

      <TweaksPanel>
        <TweakSection label="Owner mode" />
        <TweakToggle
          label="Edit articles"
          value={!!t.ownerMode}
          onChange={(v) => setTweak("ownerMode", v)}
        />
